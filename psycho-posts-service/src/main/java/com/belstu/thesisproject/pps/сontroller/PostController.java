...
public class PostController {
  ...
  @GetMapping("/{id}")
  public PsychoPost getPostById(@PathVariable final String id) throws PostNotFoundException {
    return postService.getPostById(id);
  }

  @GetMapping("/{id}/posts")
  public List<PsychoPost> getPostByAuthorId(@PathVariable final String id)
  ...
  @PostMapping
  public PsychoPost savePost(@RequestBody final PsychoPost post) {
