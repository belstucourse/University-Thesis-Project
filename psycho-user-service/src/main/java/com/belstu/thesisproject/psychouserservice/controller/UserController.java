...
public class UserController {
    ...
    @GetMapping
    public UserDto getUserByEmail(@RequestParam final String email)
    ...
    public UserDto updateUser(@RequestBody @Valid final UserDto userDto) throws UserNotFoundException {
        final User user = userMapper.map(userDto);
